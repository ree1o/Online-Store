...
function displayRegisterForm() {
  ...
  document.getElementById("profile").style.display = "none"; // Hide profile on registration
}
...
function displayLoginForm() {
  ...
  document.getElementById("logoutBtn").style.display = "none";
  document.getElementById("profile").style.display = "none"; // Hide profile on login
}
